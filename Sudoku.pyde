...
def flowchart_section(xflowchart, yflowchart):
    ...
    drawArrow(xflowchart, yflowchart+25, y1)

    y2 = process_type(xflowchart, y1+50, 100, "Initialize Grid")
    drawArrow(xflowchart, y1 + 100, y2-55)
    ...
    text_box(xflowchart + 30, y4 - 75, 1, "TRUE")
    ...
    drawArrow(xflowchart, y4 + 50, y5-30)
    drawArrowHorizontal(xflowchart, xflowchart + 200, y5 - 30)

    y5alt = process_type(xflowchart + 200, y4, 100, "Show Mistake")
    drawArrow(xflowchart + 200, y4+50, y5-5)

    start_stop_type(xflowchart + 200, y5alt + 20 ,100, "END")
